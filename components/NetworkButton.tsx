                ...
                <Menu.Item key={id}>
                  {
                    <div
                      ...
                      className={`${
                        id === chain?.id ? "text-indigo-600 bg-indigo-50" : ""
                      } cursor-pointer flex items-center justify-between pl-3 pr-2 py-2 duration-150 text-gray-500 hover:text-indigo-600 hover:bg-indigo-50`}
                    >
                      {name}
                      {id === chain?.id && (
                        <svg
